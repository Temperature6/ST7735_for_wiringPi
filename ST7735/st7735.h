...
#define ST7735_SPI_PORT			0			//SPI设备通道

#define ST7735_RES_Pin       	9			//SPI重置
#define ST7735_CS_Pin        	10			//SPI片选
#define ST7735_DC_Pin        	13			//SPI 数据/命令选择
#define ST7735_SPI_SPEED		50000000	//SPI通信速率,越高刷新越快,过高会坏掉
